...
const translations = {
  it: {
    ...
    tech: "Area Tecnica", techDesc: "Infinite specifiche prodotto AP 05.1.1.",
  ...
  en: {
    ...
    tech: "Technical Area", techDesc: "Unlimited AP 05.1.1 product specifications.",
  ...
  fr: {
    ...
    tech: "Espace Technique", techDesc: "SpÃ©cifications AP 05.1.1 illimitÃ©es.",
    ...
    ap05_title: "AP 05.1.1 SPÃ‰CIFICATION DU PRODUIT",
  ...
  es: {
    ...
    tech: "Ãrea TÃ©cnica", techDesc: "Especificaciones AP 05.1.1 ilimitadas.",
    ...
    ap05_title: "AP 05.1.1 ESPECIFICACIÃ“N DEL PRODUCTO",
